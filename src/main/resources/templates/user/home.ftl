...
<#--      <i class="layui-badge fly-badge-vip">VIP3</i>-->
    ...
    <p class="fly-home-info">
      <i class="iconfont icon-tongzhi" title="发表文章"></i><span style="color: #FF7200;">${user.postCount}</span>
    ...
    <div class="layui-row layui-col-space15">
      ...
      <div class="layui-col-md6 fly-home-da">
        <div class="fly-panel">
          ...
          <ul class="home-jieda">
           <#list askMessList as askMess>
             <script>
               console.log(${askMess});
             </script>
             <li>
                <p>
                  <span>${timeAgo(askMess.created)}</span>
                  在<a href="/post/${askMess.postId}" target="_blank">${askMess.title}</a>中回答：
                </p>
