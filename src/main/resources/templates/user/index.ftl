...
<@layout "用户中心">
    ...
    <div class="fly-panel fly-panel-user" pad20>
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title" id="LAY_mine">
          <li data-type="mine-jie" lay-id="index" class="layui-this">我发的帖（<span id="fabuTotal"></span>）</li>
          <li data-type="collection" data-url="/collection/find/" lay-id="collection">我收藏的帖（<span id="collectionTotal"></span>）</li>
        </ul>
            ...
            <ul class="mine-view jie-row" id="fabu">
              <script id="tpl-fabu" type="text/html">
                <li>
                  ...
                  <a class="mine-edit" href="/post/edit?id={{d.id}}">删除</a>
  ...
  <script>
    ...
    layui.use(['laytpl', 'flow', 'util'], function() {
      ...
      $.get('/user/publicTotalAndCollectionTotal', function(res){
        $("#fabuTotal").append(res.data.publicTotal);
        $("#collectionTotal").append(res.data.collectionTotal);
      });
      ...
      flow.load({
        ...
        ,done: function(page, next){
          var lis = [];
          $.get('/user/public?pageCurrent='+page +'&pageSize='+pageSize, function(res){
      ...
      flow.load({
        ...
        ,done: function(page, next){
          ...
          $.get('/user/collection?pageCurrent='+page + '&pageSize='+pageSize, function(res){
            layui.each(res.data.records, function(index, item){
